...
namespace proba
{
    class Program
    {
        ...
        static void UjUgyfel()
        {
            ...
            StreamWriter ujAllomany = new StreamWriter(".txt", true);
        ...
        static void meglevo()
        {
            ...
            {
                Console.WriteLine("{0} {1} {2}", u.azonosito,u.nev,u.tel);
            }
        }
        static void Main(string[] args)
        {
            string[] ugyfelfalj = File.ReadAllLines("ugyfelek.txt");
            for (int i = 0; i < ugyfelfalj.Length; i++)
            {
                ugyfel ujugyfel = new ugyfel();
                ujugyfel.azonosito = int.Parse(ugyfelfalj[i].Split("\t")[0]);
                ujugyfel.nev = ugyfelfalj[i].Split("\t")[1];
                ujugyfel.tel = ugyfelfalj[i].Split("\t")[2];
